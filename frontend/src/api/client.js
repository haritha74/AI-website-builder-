...
const renderApiHostname = import.meta.env.VITE_API_HOSTNAME;

export const API_URL =
  import.meta.env.VITE_API_URL ||
  (renderApiHostname ? `https://${renderApiHostname}/api` : import.meta.env.PROD ? "/api" : "http://localhost:5000/api");
